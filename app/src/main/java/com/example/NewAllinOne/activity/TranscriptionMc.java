...
public class TranscriptionMc extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_transcription_mc);
    ...
    {
        pregunta.setText(database.get(objetivo).getDefinitionTranslate());
    ...
    {
        Controlador.guardar(this, database,3);
        this.finish();
    }
